...
class ActivityService {
    ...
    newActivity = async(name, description, modulefk) => {
        ...
        await fetch(this.backendUrl + '/api/activity/new', {
            ...
            .then((json) => {
                console.log(json)
                this.selectedActivity._id = json.activity._id
                this.selectedActivity.name = json.activity.name
                this.selectedActivity.description = json.activity.description
                this.selectedActivity.modulefk = json.activity.moduleFk
