    ...
    newSession = async(title, description, categoryfk, programfk) => {
        ...
        await fetch(this.backendUrl + '/api/session/new', {
            ...
            .then((json) => {
                ...
                this.selectedSession._id = json.session._id
                this.selectedSession.title = json.session.title
                this.selectedSession.description = json.session.description
                this.selectedSession.categoryfk = json.session.categoryFk
                this.selectedSession.programfk = json.session.programFk
            })
    }
